<template>
  <SmTextLayout>
    <div class="flex-center flex-col h100">
      <div class="flex-center">
        <a href="https://www.youtube.com/watch?v=GuJQSAiODqI" target="blank">
          I'm a link to somewhere else
        </a>
        <a href="https://springmatter.com" target="blank" class="black">
          I'm a black link
        </a>
      </div>
      <br />
